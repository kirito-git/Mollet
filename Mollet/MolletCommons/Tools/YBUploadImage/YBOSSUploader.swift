...
//    public let endPoint = "https://oss-cn-hangzhou.aliyuncs.com"
    ...
    init() {
        ...
        let ossInfo = WDBGlobalDataUserDefaults.getOSSInfo() as! YBOSSInfo
        self.accessKey = ossInfo.ossKey ?? ""
        self.secretKey = ossInfo.ossSecret ?? ""
        self.ossAliYunHost = ossInfo.ossUrl ?? ""
        self.ossBucketName = ossInfo.ossBucketName ?? ""
        self.ossFileDir = ossInfo.ossFileDir ?? ""
